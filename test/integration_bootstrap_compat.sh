...
# blog post, which uses the installed al-folio page layout.
index_no_compat="${site_no_compat}/blog/2015/disqus-comments/index.html"
...
index_with_compat="${site_with_compat}/blog/2015/disqus-comments/index.html"
